...
/**
 * Uso questa classe solo per operazioni di caricamento del blob quando
 * necessario.
 * 
 * @author 1871
 *
...
public abstract class DocumentoBlobDBDef extends DocumentoDTO {
     ...
     */
    @Override
    @ColumnLOB(name = "DOCUMENTO")
    public abstract byte[] getDocumento();
